...
- `src/engine/` owns command routing, session state, permissions, webhook delivery, and cron jobs.
- `src/markdown/`, `src/permissions/`, and `src/delivery/` contain mostly pure logic and should keep tight unit coverage.
